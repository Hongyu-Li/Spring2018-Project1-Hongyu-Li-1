...
![](E:/Columbia University/2018Spring/Applied Data Science/Project1/report/fig/donkey vs elephant.jpg)
...
setwd('E:/Columbia University/2018Spring/Applied Data Science/Project1/report/data/')
...
setwd('E:/Columbia University/2018Spring/Applied Data Science/Project1/report/output/democratic')
...
speech.democratic<-Corpus(DirSource('E:/Columbia University/2018Spring/Applied Data Science/Project1/report/output/democratic'))
...
setwd('E:/Columbia University/2018Spring/Applied Data Science/Project1/report/output/republican')
...
speech.republican<-Corpus(DirSource('E:/Columbia University/2018Spring/Applied Data Science/Project1/report/output/republican'))
...
![](E:/Columbia University/2018Spring/Applied Data Science/Project1/report/fig/wordcloud_democratic.jpg)
\


![](E:/Columbia University/2018Spring/Applied Data Science/Project1/report/fig/wordcloud_republican.jpg) 
\
...
Basically, presidents from both parties are trying to show positivity and trust bacause these columns have the darkest color in the heatmap. According to this map, we could say that the Democratic Party is more positive than the Republican Party and the Republic Party is more trustful in their speeches than the Democratic Party. What's more, anticipation, joy, fear and negativity also play some roles in their speeches but it seems that they do not have big difference between two parties.
\
...
![](E:/Columbia University/2018Spring/Applied Data Science/Project1/report/fig/summary.jpg)
